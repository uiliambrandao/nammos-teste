...
const CheckoutPage: React.FC = () => {
  ...
  // Mock Totals (In a real app, pass via location.state or Context)
              ...
              {paymentMethod === 'pix' && (
                <div className="mt-3 pl-8 animate-fade-in-down">
                  <p className="text-xs text-gray-500">
                    Confirmaremos o pedido e você poderá copiar a chave PIX na próxima tela.
                  </p>
                </div>
              )}
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 sm:p-6 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xs text-gray-400 mt-3">
            Você receberá atualizações do seu pedido em tempo real.
          </p>
        </div>
      </div>
