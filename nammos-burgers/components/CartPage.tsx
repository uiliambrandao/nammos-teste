      ...
      async (position) => {
        ...
        try {
          ...
          if (data && data.address) {
            ...
            let postcode = addr.postcode ? addr.postcode.replace(/\D/g, '').substring(0, 8).replace(/^(\d{5})(\d)/, '$1-$2') : '';
          ...
          alert('Erro ao obter endereço pelo GPS.');
        } finally {
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] pb-40 font-sans relative">
      ...
      <main className="max-w-2xl mx-auto pt-24 px-4 sm:px-6 space-y-6 animate-fade-in-down">
        ...
        <button 
          onClick={() => navigate('/menu')}
          className="w-full py-3.5 rounded-xl border-2 border-dashed border-gray-200 text-gray-500 font-bold text-sm hover:border-brand-orange hover:text-brand-orange hover:bg-orange-50 transition-all flex items-center justify-center gap-2 group"
        >
           <div className="bg-gray-100 rounded-full p-1 group-hover:bg-orange-100 transition-colors">
          ...
          <div className="bg-white rounded-[24px] w-full max-w-md p-6 relative z-10 shadow-2xl animate-fade-in-down">
            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto hide-scrollbar">
              ...
              <button
                ...
                className="w-full py-3 bg-orange-50 border border-orange-100 rounded-xl flex items-center justify-center gap-2 text-brand-orange font-bold text-sm hover:bg-orange-100 transition-colors"
              >
                 {loadingLocation ? (
